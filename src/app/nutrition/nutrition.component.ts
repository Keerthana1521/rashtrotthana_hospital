...
export class NutritionComponent {
  ...
  ngOnInit(): void {
    this.titleService.setTitle("Comprehensive Dietician Services - Rashtrotthana Hospital");  
